...
app.get(
  "/api/fuel-pricings/fuel-pricings-list",
  (req: express.Request, res: express.Response) => {
...
app.get(
  "/api/fuel-pricings/:fuelPricingId",
  (req: express.Request, res: express.Response) => {
...
app.put(
  "/api/fuel-pricings/update-fuel-pricing",
  (req: express.Request, res: express.Response) => {
...
app.get(
  "/api/containers/containers-list",
  (req: express.Request, res: express.Response) => {
...
app.put(
  "/api/containers/update-container",
  (req: express.Request, res: express.Response) => {
    const {
      id,
      dropOffDate,
...
app.get(
  "/api/finance-desk/finance-desk-list",
  (req: express.Request, res: express.Response) => {
...
app.get(
  ...
  (req: express.Request, res: express.Response) => {
    ...
    const result = paginateFilterSort(
      employeeExpenses.items,
      req.query,
      "employee"
    );
...
app.get(
  ...
  (req: express.Request, res: express.Response) => {
    ...
    const employeeExpense = employeeExpenses.items.find(
      (b) => b.id === employeeExpenseId
    );
    if (employeeExpense) {
...
app.put(
  ...
  (req: express.Request, res: express.Response) => {
    ...
    const employeeExpenseIndex = employeeExpenses.items.findIndex(
      (b) => b.id === id
    );
...
app.get(
  "/api/compensations/compensations-list",
  (req: express.Request, res: express.Response) => {
...
app.get(
  "/api/compensations/:compensationId",
  (req: express.Request, res: express.Response) => {
...
app.put(
  "/api/compensations/update-compensation",
  (req: express.Request, res: express.Response) => {
    const {
      id,
      document,
...
app.get(
  "/api/statements/statements-list",
  (req: express.Request, res: express.Response) => {
...
app.get(
  ...
  (req: express.Request, res: express.Response) => {
    ...
    const statement = statements.items.find(
...
app.post(
  "/api/statements/create-statement",
  (req: express.Request, res: express.Response) => {
    const {
      statementNumber,
      bank,
...
app.put(
  "/api/statements/update-statement",
  (req: express.Request, res: express.Response) => {
    const {
      id,
      statementNumber,
...
app.post(
  "/api/equipment/create-equipment-item",
  (req: express.Request, res: express.Response) => {
    const { name } = req.body;
    const newEquipment = {
...
app.put(
  "/api/equipment/update-equipment-item",
  (req: express.Request, res: express.Response) => {
    const { id, name } = req.body;
...
app.get(
  "/api/stimulations/stimulations-list",
  (req: express.Request, res: express.Response) => {
...
app.get(
  "/api/stimulations/:stimulationsId",
  (req: express.Request, res: express.Response) => {
...
app.post(
  "/api/stimulations/create-stimulation",
  (req: express.Request, res: express.Response) => {
...
app.put(
  "/api/stimulations/update-stimulation",
  (req: express.Request, res: express.Response) => {
...
app.get(
  "/api/suspensions/suspensions-list",
  (req: express.Request, res: express.Response) => {
...
app.post(
  "/api/suspensions/create-suspension",
  (req: express.Request, res: express.Response) => {
    const { type, employee, date, amount, description, firstInstallmentDate } =
      req.body;
    const newSuspension = {
...
app.put(
  "/api/suspensions/update-suspension",
  (req: express.Request, res: express.Response) => {
    const {
      id,
      type,
...
app.get(
  "/api/calculations/calculations-list",
  (req: express.Request, res: express.Response) => {
...
app.post(
  ...
  (req: express.Request, res: express.Response) => {
    const { employee, date, amount, description, salary, month, year } =
      req.body;
...
app.put(
  "/api/calculations/update-calculation",
  (req: express.Request, res: express.Response) => {
    const { id, employee, date, amount, description, salary, month, year } =
      req.body;
